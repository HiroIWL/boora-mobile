...
export function AuthenticatedProvider({ children }: { children: ReactNode }) {
  ...
  return (
    <AuthenticatedContext.Provider value={{ isAuthenticated, setIsAuthenticated, clear }}>
      {children}
...
export function useAuthenticated() {
  ...
  if (!context) throw new Error('useToken deve ser usado dentro de TokenProvider');
  return context;
}
